...
Client.prototype.getCollection = function(){
      ...
      response.on('end',function(){
        if(response.statusCode < 200 || response.statusCode > 299){
            ...
            try {
                ...
                msg_obj = {
                    responseHeader: message.responseHeader || response.statusCode,
                    error: message.error && message.error.msg ? message.error.msg : text
                };
            }
            
            if(callback)  callback(msg_obj,null);
         }else{
            try{
